...
//    private double value = 0d;
	...
	private String valStr = "0";
    private String name;
    private boolean constant = false;
    private boolean isJson = false;
    private boolean isStrVal = false;
    /**
    ...
    protected Variable(String name) {
        this.name = name;
        if(!TextUtil.isNum(name)&&TextUtil.isChs(name)){
        	this.valStr = name;
        }
    }
    ...
    public Variable withValue(JSONObject value){
    	this.valStr = value.toJSONString();
    	this.isJson = true;
    	return this;
    }
	...
	public String getValStr() {
		if(isJson||isStrVal||!"0".equals(valStr)){
			return valStr;
		}else{
