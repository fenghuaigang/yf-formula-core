 ...
 * <p>
 * By first collecting as many {@link parsiii.tokenizer.ParseError} instances as possible, this permits to provide good insights
...
public class ParseException extends Exception {
    ...
    private final transient List<parsiii.tokenizer.ParseError> errors;

    private ParseException(String message, List<parsiii.tokenizer.ParseError> errors) {
        super(message);
        this.errors = errors;
    }
     ...
     */
    public static ParseException create(List<parsiii.tokenizer.ParseError> errors) {
        if (errors.size() == 1) {
     ...
     */
    public List<parsiii.tokenizer.ParseError> getErrors() {
        return errors;
    }
