...
public class ParseError {
    ...
    private parsiii.tokenizer.Position pos;
     ...
     */
    protected ParseError(parsiii.tokenizer.Position pos, String message, Severity severity) {
        this.pos = pos;
     ...
     * <p>
     * If no position is available {@link parsiii.tokenizer.Position#UNKNOWN} can be used
     *
     ...
     */
    public static ParseError warning(parsiii.tokenizer.Position pos, String msg) {
        String message = msg;
        if (pos.getLine() > 0) {
     ...
     */
    public static ParseError error(parsiii.tokenizer.Position pos, String msg) {
        String message = msg;
        if (pos.getLine() > 0) {
            message = String.format("%3d:%2d: %s", pos.getLine(), pos.getPos(), msg);
        }
